...
class TestFraction(unittest.TestCase):
    ...
    def test_fraction(self):
        ...
        self.assertEqual(2, f4.numerator)
        self.assertEqual(5, f4.denominator)
        with self.assertRaises(ZeroDivisionError):  # ¿lanza excepción con denominador cero?
            Fraction(1, 0)

    def test_get_num(self):
        self.assertEqual(1, self.f1.numerator)
        self.assertEqual(2, self.f2.numerator)

    def test_get_den(self):
        self.assertEqual(2, self.f1.denominator)
        self.assertEqual(3, self.f2.denominator)
